...
1. Скачайте готовый release-пакет клиента.
2. Запустите `BelfProctor.exe`.
3. Заполните настройки подключения и сохраните их.
4. Подтвердите запрос UAC, если Windows попросит права администратора для регистрации службы.
5. Дождитесь завершения установки.

> На целевой машине не требуется .NET SDK, NuGet или сборка проекта. Клиент должен распространяться как заранее собранный self-contained `.exe`.
